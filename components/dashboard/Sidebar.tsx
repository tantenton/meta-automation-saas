...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 min-h-screen flex flex-col" style={{ backgroundColor: '#111111', borderRight: '1px solid #222' }}>
      {/* Logo */}
      <div className="px-6 py-5 border-b" style={{ borderColor: '#222' }}>
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-white text-sm">Meta Automation</span>
        </div>
      </div>
      ...
      <nav className="flex-1 px-3 py-4 space-y-1">
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              <span style={{ color: isActive ? '#818cf8' : '#6b7280' }}>{item.icon}</span>
              {item.label}
            </Link>
          );
        })}
