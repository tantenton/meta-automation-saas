...
export async function GET(request: Request) {
  ...
  url.searchParams.set('scope', 'threads_basic,threads_content_publish,threads_manage_replies,threads_read_replies,threads_profile_discovery,threads_keyword_search');
